...
kartik_image = face_recognition.load_image_file("faces/kartik.jpg")
kartik_encoding = face_recognition.face_encodings(kartik_image)[0]


known_face_encodings = [shahrukh_encoding,salman_encoding,kartik_encoding]
known_face_names = ["ShahRukh","Salman","Kartik"]
